...
def add_employee_function():
    ...
    insert_sql= "INSERT into employee(emp_id,first_name,last_name,age,gender,location,pri_skill,email,department,job,salary,hire_date) VALUES  (%s, %s, %s, %s, %s, %s, %s, %s,%s, %s, %s, %s, %s)"
